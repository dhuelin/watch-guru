...
| [#39](https://github.com/dhuelin/watch-guru/issues/39) | Connect Plex, Jellyfin, Emby and Trakt | Watching something should record it without anybody marking anything. Plex is connected; see [`PLEX.md`](PLEX.md) |

...
| [#39](https://github.com/dhuelin/watch-guru/issues/39) | Connect Plex, Jellyfin, Emby and Trakt | Watching something should record it without anybody marking anything. Plex and Trakt are connected; see [`PLEX.md`](PLEX.md) and [`TRAKT.md`](TRAKT.md) |

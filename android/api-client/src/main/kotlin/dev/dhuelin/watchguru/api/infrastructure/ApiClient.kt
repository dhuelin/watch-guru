package dev.dhuelin.watchguru.api.infrastructure

import dev.dhuelin.watchguru.api.auth.HttpBearerAuth
...
import dev.dhuelin.watchguru.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "dev.dhuelin.watchguru.api.baseUrl"
        @Deprecated(

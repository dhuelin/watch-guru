...
class WatchGuruApplicationTests {
     ...
     * puts a dead "Connect" button in front of everybody. Plex, Jellyfin, Emby
     * and Trakt can, which is what #39 built.
     */
    @Test
    void onlyServicesThatCanActuallySyncAreMarkedSyncable() {
        ...
        assertThat(slugs).containsExactly("emby", "jellyfin", "plex", "trakt");
    }
}

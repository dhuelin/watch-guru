...
open class WatchGuruAPIAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = WatchGuruAPIAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: WatchGuruAPIAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: WatchGuruAPIAPIConfiguration = WatchGuruAPIAPIConfiguration.shared
    ) {
        self.method = method
